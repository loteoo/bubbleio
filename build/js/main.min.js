...
const BubbleItem = ({bubble, currentBubble}) =>
  h('li', {current: (bubble.name == Object.assign({"name": ""}, currentBubble).name).toString(), userCount: bubble.userCount}, [
    Link({to: "/" + bubble.name}, [
      bubble.title,
      h('div', {class: "users"}, [
        h('div', {class: "icon"}),
...
const ThreadHeader = ({thread, currentBubble}) =>
  h('div', {class: "header"}, [
    h('h2', null, [shortenText(thread.title, 32)]),
...
const ThreadFooter = ({thread}) => (state, actions) => (
  h('div', {class: "footer"}, [
    ...
    h('div', {class: "upvote"}, [
      h('button', {class: "count", score: thread.score, onclick: ev => {
        ev.stopPropagation();
...
const ThreadKeyboard = ({currentBubble}) => (state, actions) =>
  h('form', {class: "keyboard threadKeyboard", 'data-mode': "default", onsubmit: ev => {
    ...
    h('input', {type: "text", name: "title", placeholder: "Type something...", class: "title", maxlength: "50"}),
