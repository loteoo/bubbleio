...
const Thread = (thread, currentBubble, actions, display = "summary") => {
  if (!thread.userCount) {
    thread.userCount = 0;
  }
  if (!thread.messages) {
  ...
  if (display == "summary") {
    ...
    return (
      h('li', {key: thread._id, class: "thread", 'data-type': thread.type, 'data-upvoted': thread.upvoted, 'data-display': display}, [
        h('div', {class: "header"}, [
