...
const ThreadItem = ({thread, index, currentBubble, currentThread}) => (state, actions) =>
    h('li', {key: thread._id, class: "thread", index: index, type: thread.type, upvoted: thread.upvoted, opened: (thread._id == currentThread._id).toString(), onclick: ev => {
...
const Thread = ({currentThread, currentBubble}) => (state, actions) => {
  ...
  return (
    h('li', {key: currentThread._id, class: "thread", 'data-type': currentThread.type, 'data-upvoted': currentThread.upvoted}, [
      h('div', {class: "header"}, [
