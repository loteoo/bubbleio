  ...
  return (
    h('div', {class: "overlay"}, [
      h('div', {class: "inner"}, [
        ...
        h('form', {class: "bubbleForm" + extraClass, onsubmit: ev => {
            ev.preventDefault();
...
const BubbleItem = ({bubble, currentBubble}) => {
  ...
  return (
    h('li', {class: currentClass, userCount: bubble.userCount}, [
      Link({to: "/" + bubble.name}, [
        bubble.title,
        h('div', {class: "users"}, [
          h('div', {class: "icon"}),
...
const ThreadItem = ({thread, index, currentBubble, currentThread}) => (state, actions) =>
    h('li', {key: thread._id, class: "thread", index: index, type: thread.type, upvoted: thread.upvoted, opened: (thread._id == currentThread._id).toString(), hasthumbnail: (typeof thread.src != "undefined").toString(), onclick: ev => {
...
const Thread = ({currentThread, currentBubble}) => (state, actions) => {
  ...
  if (currentThread.type == "default") {
    ...
    contentBlock = h('div', {class: "text"}, [currentThread.text]);
    ...
    contentBlock = h('a', {href: currentThread.url, target: "_blank", class: "link"}, [currentThread.url]);
  } else if (currentThread.type == "image") {
    contentBlock = h('a', {href: currentThread.src, target: "_blank", class: "img"}, [h('img', {src: currentThread.src, alt: currentThread.title})]);
  }
  ...
  return (
    h('article', {key: currentThread._id, class: "thread", type: currentThread.type, upvoted: currentThread.upvoted}, [
      h('div', {class: "header"}, [
        ...
        h('p', null, ["by " + currentThread.author + " on " + currentBubble.name + " " + timeSince(currentThread.created)])
      ]),
      contentBlock
    ])
  )
