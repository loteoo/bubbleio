...
const ThreadItem = ({thread, index, currentBubble, currentThread}) => (state, actions) => {
  return (
    h('li', {key: thread._id, class: "thread", index: index, type: thread.type, upvoted: thread.upvoted, current: (thread._id == Object.assign({'_id': ""}, currentThread)._id).toString(), onclick: ev => {
  ...
  if (window.innerWidth >= 768) { // If desktop
    return (
      h('div', {class: "inner desktop"}, [
        h('div', {class: "thumbnail", Style: "background-image: url('"+getThumbnail(thread)+"')"}),
        h('div', {class: "info"}, [
