...
const ThreadItem = ({thread, index, currentBubble, currentThread}) => (state, actions) => {
  return (
    h('li', {key: thread._id, class: "thread", index: index, type: thread.type, upvoted: thread.upvoted, hasthumbnail: (typeof thread.src != "undefined").toString(), opened: (thread._id == Object.assign({'_id': ""}, currentThread)._id).toString(), onclick: ev => {
